        ...
        render={({ state, fullpageApi }) => (
          <ReactFullpage.Wrapper>
            ...
            <div className="section bg-primary ">
              <h2 className="text-4xl font-serif text-cream mb-8 flex flex-col items-center justify-center px-4">Featured Drinks</h2>
              ...
              {featuredDrinks.map((drink) => (
                    ...
                    >
                      <div className="bg-cream p-4 rounded-lg shadow-lg relative">
                        <div 
                          className={`absolute left-0 right-0 bottom-full mb-2 bg-white p-4 rounded-lg shadow-lg text-primary transition-all duration-300 ease-in-out z-50 ${
                            hoveredDrink === drink.name ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 pointer-events-none'
                          }`}
                          style={{
                            maxWidth: '100%',
                            width: '250px', // Adjust this value as needed
                            left: '50%',
                            transform: hoveredDrink === drink.name ? 'translateX(-50%) translateY(0)' : 'translateX(-50%) translateY(10px)',
                          }}
                        >
