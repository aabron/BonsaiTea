                ...
                {isMenuOpen && (
                    <nav className="absolute top-full left-0 bg-white p-6 rounded-lg shadow-lg mt-2 w-[14rem]">
                        <ul className="space-y-4">
                            ...
                            <li><Link to="/surprise_suggestion" className="text-primary font-bold flex items-center text-xl hover:text-secondary transition-colors" onClick={() => setIsMenuOpen(false)}><IoFastFood className='mr-3 text-2xl' />Tea Blends</Link></li>
